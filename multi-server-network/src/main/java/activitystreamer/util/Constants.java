...
public class Constants {
    ...
    public static class Info {
        ...
        public static final String AUTH_FAIL_SECRET_INCORRECT = "The supplied secret is incorrect:";
        public static final String LOGIN_SUCCESS_INFO = "Logged in as user";
        public static final String LOGIN_FAILED_INFO = "Attempt to login with wrong username/secret";
        public static final String REGISTER_FAILED_INFO = "is already registered with the system";
